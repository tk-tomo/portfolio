...
$intention = get_field('intention');
$opus_title = get_field('opus_title');
?>
  ...
  <section class="container_fild">
    <section class="container">
                ...
                <dl>
                  ...
                  <div class="work_title_about_text">
                    ...
                    <dd>
                      配色
                      <div class="color">
                        <img src="<?php echo esc_url($color_img['url']); ?>" alt="<?php echo esc_attr($color_img['alt']); ?>">
                      </div>
                    </dd>
                    <br>
                  ...
                  <div class="work_title_about_text">
                    ...
                    <?php if (have_rows('site_url_rows')):
                      while (have_rows('site_url_rows')): the_row();
                        ...
                        <dd>
                          <a href="<?php echo esc_url($site_url); ?>" target="_blank" rel="noopener noreferrer" class="hover_yellow">
                            <?php echo esc_html($site_url_txt); ?>
                          </a>
                        </dd>
                      <?php endwhile;
                    endif; ?>
      ...
      <?php elseif ($layout === 'poster'): ?>
          ...
          <div class="work_position2 slider">
            <?php if (have_rows('work_slick')):
              while (have_rows('work_slick')): the_row();
                ...
                <div>
                  <img src="<?php echo esc_url($work_img['url']); ?>" alt="<?php echo esc_attr($work_img['alt']); ?>" />
                  <p class="slider_text"><?php echo $work_txt; ?></p>
                </div>
              <?php endwhile;
            endif; ?>
          </div>
        ...
        <div class="work_about_box">
          <h1><?php echo esc_html($work_title); ?></h1>
          <?php if (have_rows('poster_repeat')):
            while (have_rows('poster_repeat')): the_row();
              $opus_title = get_sub_field('opus_title');
              $intention = get_sub_field('intention');
              $tool = get_sub_field('tool');
              $award = get_sub_field('award'); ?>
              <div class="work_about_section">
                <ul class="work_about_section_flex">
                  <li class="work_about_title_box">
                    <?php if ($award) { echo '<p>受賞作品</p>'; } ?>
                    <dl>
                      <dt><h2>作品タイトル</h2></dt>
                      <dd class="work_about_title"><?php echo $opus_title; ?></dd>
                    </dl>
                  </li>
                  <li class="work_title_about">
                    <dl>
        ...
        <!-- ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー -->
         <!-- 名刺 -->
         <?php elseif($layout === 'business_card'):?>
        <div id="slider" class="background">
            <div class="work_position2 slider">
            <?php if (have_rows('work_slick')):
              while (have_rows('work_slick')): the_row();
        ...
        <div class="work_about_box">
            <h1><?php echo esc_html($work_title); ?></h1>
            <?php if(have_rows('business_card_repeat')):
            while(have_rows('business_card_repeat')): the_row();
            $opus_title = get_sub_field('opus_title');
            $intention = get_sub_field('intention');
            $tool = get_sub_field('tool');
              ?>
        ...
        <div class="work_about_box">
            <h1><?php echo esc_html($work_title); ?></h1>
            <?php if(have_rows('banner_repeat')):
            while(have_rows('banner_repeat')): the_row();
            $opus_title = get_sub_field('opus_title');
            $tool = get_sub_field('tool');
            ...
            <div class="work_about_section">
                <ul class="work_about_section_flex">
                    <li class="work_about_title_box">
                        <h2><?php echo esc_html($opus_title); ?></h2>
                    </li>
                    <li class="work_title_about">
                        <dl>
                            <div class="work_title_about_text">
