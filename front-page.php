          ...
          <div class="flexRight">
            <ul>
              <li class="serviceList">
                <div><p>01</p></div>
                <div>
                  <h3>コーディング・<br class="sp_nav">フロントエンド開発</h3>
                  <p>HTML、SCSS、CSS、JS、PHP、Gulp、GSAP、yarn-webpack、GitHub、SourceTree、WordPressを使ってサイトを作っています。単に指示通りに組むだけでなく、保守性や情報設計を重視し、ユーザーが迷わず操作できる使いやすいサイトを作ります。</p>
                </div>
              </li>
              <li class="serviceList">
                <div><p>02</p></div>
                <div>
                  ...
                  <p>
                    主にIllustrator、Photoshop、XD、Figmaを使用しています。<br>
                    バナー制作や写真加工といったグラフィック制作はもちろん、後工程のコーディングを常に意識した「実装しやすいデザイン」が強みです。<br>
                    単にデザインを渡して終わりではなく、実装する人が一番使いやすい状態でデータを渡す。そんな「後工程への思いやり」を考えた丁寧な制作を心がけています。
                  </p>
                </div>
              </li>
              <li class="serviceList">
                ...
                <div>
                  ...
                  <p class="scrollBottom">
                   既存テーマのカスタマイズはもちろん、カスタムフィールドを使用した「専門知識がなくても管理画面から直感的に更新できる」仕組み作りが得意です。<br>
                   作っておわりではなく、納品後の使いやすさを第一に考え、セキュリティや表示速度といった長く運用するための土台作りもしっかりと行います。
                  </p>
                </div>
              </li>
            </ul>
